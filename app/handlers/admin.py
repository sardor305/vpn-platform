...
async def search_bonus_statistics(callback: CallbackQuery):
    ...
    text = (
        ...
        "━━━━━━━━━━━━━━━━━━\n\n"
        "👨‍💼 <b>ADMIN BONUS</b>\n"
        f"├ Jami: <b>{admin_bonus.total}</b>\n"
        f"├ 🟢 Faol: <b>{admin_bonus.active}</b>\n"
        f"├ ⏳ Kutilmoqda: <b>{admin_bonus.pending}</b>\n"
        f"├ ⚪ Tugagan: <b>{admin_bonus.expired}</b>\n"
        f"└ 🚫 Bekor qilingan: <b>{admin_bonus.revoked}</b>"
    )
...
def _render_bonus_statistics(stats) -> str:
    ...
    return (
        ...
        "━━━━━━━━━━━━━━━━━━\n\n"
        "📦 <b>WELCOME BONUS</b>\n"
        f"├ Jami: <b>{welcome.total}</b>\n"
        f"├ 🟢 Faol: <b>{welcome.active}</b>\n"
        f"├ ⏳ Kutilmoqda: <b>{welcome.pending}</b>\n"
        f"├ ⚪ Tugagan: <b>{welcome.expired}</b>\n"
        f"├ 🚫 Bekor qilingan: <b>{welcome.revoked}</b>\n"
        f"├ 📦 Jami trafik: <b>{format_traffic(traffic.total_limit_bytes)}</b>\n"
        f"├ 📊 Ishlatilgan: <b>{format_traffic(traffic.total_used_bytes)}</b>\n"
        f"├ 📉 Qolgan: <b>{format_traffic(traffic.remaining_bytes)}</b>\n"
        f"├ ⚠️ 500 MB warning: <b>{traffic.warning_500mb_sent}</b>\n"
        f"└ 🚫 Trafiki tugagan: <b>{traffic.exhausted}</b>\n\n"
        "━━━━━━━━━━━━━━━━━━\n\n"
        "👨‍💼 <b>ADMIN BONUS</b>\n"
        f"├ Jami: <b>{admin.total}</b>\n"
        f"├ 🟢 Faol: <b>{admin.active}</b>\n"
        f"├ ⏳ Kutilmoqda: <b>{admin.pending}</b>\n"
        f"├ ⚪ Tugagan: <b>{admin.expired}</b>\n"
        f"└ 🚫 Bekor qilingan: <b>{admin.revoked}</b>"
    )
